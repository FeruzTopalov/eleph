...
//Registers description in FSK/OOK mode
/*!
 * ============================================================================
...
#define RF_BITRATEMSB_3000_BPS                      0x29
#define RF_BITRATELSB_3000_BPS                      0xAA
...
#define RF_FDEVMSB_2400_HZ                          0x00
#define RF_FDEVLSB_2400_HZ                          0x27
#define RF_FDEVMSB_3000_HZ                          0x00
#define RF_FDEVLSB_3000_HZ                          0x31
 ...
 * RegFrf (MHz)
 */
#define RF_FRFMSB_434_MHZ                           0x6C
#define RF_FRFMID_434_MHZ                           0x80
#define RF_FRFLSB_434_MHZ                           0x00
...
#define RF_PACONFIG_MAX_POWER_7                  	0x70

#define RF_PACONFIG_OUTPUTPOWER_MASK                0xF0
#define RF_PACONFIG_OUTPUTPOWER_0                	0x00
#define RF_PACONFIG_OUTPUTPOWER_8                	0x08
#define RF_PACONFIG_OUTPUTPOWER_15                	0x0F
...
#define RF_RXTIMEOUT2_TIMEOUTRXPREAMBLE_25MS_2400BPS    0x04
#define RF_RXTIMEOUT2_TIMEOUTRXPREAMBLE_25MS_3000BPS    0x05
#define RF_RXTIMEOUT2_TIMEOUTRXPREAMBLE_30MS_2400BPS    0x05

/*!
 * RegRxTimeout3
 */
#define RF_RXTIMEOUT3_TIMEOUTSIGNALSYNC             	0x00  // Default
#define RF_RXTIMEOUT3_TIMEOUTSIGNALSYNC_50MS_2400BPS    0x08
#define RF_RXTIMEOUT3_TIMEOUTSIGNALSYNC_50MS_3000BPS    0x09
...
#define RF_PADAC_20DBM_ON                           0x87
#define RF_PADAC_20DBM_OFF                          0x84  // Default
...
#define RFM_CONF_ARRAY {\
		(REG_OPMODE | RFM_WRITE), 			(RF_OPMODE_SLEEP), \
		(REG_OPMODE | RFM_WRITE), 			(RF_OPMODE_LONGRANGEMODE_OFF | RF_OPMODE_MODULATIONTYPE_FSK | RF_OPMODE_SLEEP), \
		(REG_OPMODE | RFM_WRITE), 			(RF_OPMODE_STANDBY), \
		(REG_BITRATEMSB | RFM_WRITE),		(RF_BITRATEMSB_2400_BPS), \
		(REG_BITRATELSB | RFM_WRITE),		(RF_BITRATELSB_2400_BPS), \
		(REG_FDEVMSB | RFM_WRITE),			(RF_FDEVMSB_2400_HZ), \
		(REG_FDEVLSB | RFM_WRITE),			(RF_FDEVLSB_2400_HZ), \
		(REG_FRFMSB | RFM_WRITE),			(RF_FRFMSB_434_MHZ), \
		(REG_FRFMID | RFM_WRITE),			(RF_FRFMID_434_MHZ), \
		(REG_FRFLSB | RFM_WRITE),			(RF_FRFLSB_434_MHZ), \
		(REG_PACONFIG | RFM_WRITE),			(RF_PACONFIG_PASELECT_PABOOST), \
		(REG_PARAMP | RFM_WRITE),			(RF_PARAMP_MODULATIONSHAPING_00 | RF_PARAMP_0040_US), \
		(REG_OCP | RFM_WRITE),				(RF_OCP_OFF | RF_OCP_TRIM_240_MA), \
		(REG_LNA | RFM_WRITE),				(RF_LNA_GAIN_G1 | RF_LNA_BOOST_OFF), \
		(REG_RXCONFIG | RFM_WRITE),			(RF_RXCONFIG_RESTARTRXONCOLLISION_OFF | RF_RXCONFIG_AFCAUTO_ON | RF_RXCONFIG_AGCAUTO_ON | RF_RXCONFIG_RXTRIGER_PREAMBLEDETECT), \
		(REG_RSSICONFIG | RFM_WRITE),		(RF_RSSICONFIG_OFFSET_P_00_DB | RF_RSSICONFIG_SMOOTHING_8), \
		(REG_RSSICOLLISION | RFM_WRITE),	(RF_RSSICOLISION_THRESHOLD), \
		(REG_RSSITHRESH | RFM_WRITE),		(RF_RSSITHRESH_THRESHOLD), \
		(REG_RXBW | RFM_WRITE),				(RF_RXBW_MANT_24 | RF_RXBW_EXP_5), \
		(REG_AFCBW | RFM_WRITE),			(RF_AFCBW_MANTAFC_24 | RF_AFCBW_EXPAFC_4), \
		(REG_AFCFEI | RFM_WRITE),			(RF_AFCFEI_AFCAUTOCLEAR_ON), \
		(REG_PREAMBLEDETECT | RFM_WRITE),	(RF_PREAMBLEDETECT_DETECTOR_ON | RF_PREAMBLEDETECT_DETECTORSIZE_2 | RF_PREAMBLEDETECT_DETECTORTOL_10), \
		(REG_RXTIMEOUT1 | RFM_WRITE),		(0), \
		(REG_RXTIMEOUT2 | RFM_WRITE),		(RF_RXTIMEOUT2_TIMEOUTRXPREAMBLE_30MS_2400BPS), \
		(REG_RXTIMEOUT3 | RFM_WRITE),		(RF_RXTIMEOUT3_TIMEOUTSIGNALSYNC_50MS_2400BPS), \
		(REG_RXDELAY | RFM_WRITE),			(RF_RXDELAY_INTERPACKETRXDELAY), \
		(REG_OSC | RFM_WRITE),				(RF_OSC_CLKOUT_OFF), \
		(REG_PREAMBLEMSB | RFM_WRITE),		(0), \
		(REG_PREAMBLELSB | RFM_WRITE),		(8), \
		(REG_SYNCCONFIG | RFM_WRITE),		(RF_SYNCCONFIG_AUTORESTARTRXMODE_OFF | RF_SYNCCONFIG_PREAMBLEPOLARITY_AA | RF_SYNCCONFIG_SYNC_ON | RF_SYNCCONFIG_SYNCSIZE_2), \
		(REG_SYNCVALUE1 | RFM_WRITE),		(0x4B), \
		(REG_SYNCVALUE2 | RFM_WRITE),		(0xB2), \
		(REG_PACKETCONFIG1 | RFM_WRITE),	(RF_PACKETCONFIG1_PACKETFORMAT_FIXED | RF_PACKETCONFIG1_DCFREE_WHITENING | RF_PACKETCONFIG1_CRC_ON | RF_PACKETCONFIG1_CRCAUTOCLEAR_OFF | RF_PACKETCONFIG1_ADDRSFILTERING_OFF | RF_PACKETCONFIG1_CRCWHITENINGTYPE_CCITT), \
		(REG_PACKETCONFIG2 | RFM_WRITE),	(RF_PACKETCONFIG2_DATAMODE_PACKET | RF_PACKETCONFIG2_IOHOME_OFF | RF_PACKETCONFIG2_BEACON_OFF), \
		(REG_PAYLOADLENGTH | RFM_WRITE),	(0), \
		(REG_NODEADRS | RFM_WRITE),			(RF_NODEADDRESS_ADDRESS), \
		(REG_BROADCASTADRS | RFM_WRITE),	(RF_BROADCASTADDRESS_ADDRESS), \
		(REG_FIFOTHRESH | RFM_WRITE),		(RF_FIFOTHRESH_TXSTARTCONDITION_FIFONOTEMPTY), \
		(REG_SEQCONFIG1 | RFM_WRITE),		(RF_SEQCONFIG1_IDLEMODE_SLEEP | RF_SEQCONFIG1_FROMSTART_TOTX | RF_SEQCONFIG1_LPS_SEQUENCER_OFF | RF_SEQCONFIG1_FROMTX_TOLPS), \
		(REG_SEQCONFIG2 | RFM_WRITE),		(RF_SEQCONFIG2_FROMRX_TORXPKT_ONPLDRDY | RF_SEQCONFIG2_FROMRXTIMEOUT_TOLPS | RF_SEQCONFIG2_FROMRXPKT_TOLPS), \
		(REG_IMAGECAL | RFM_WRITE),			(RF_IMAGECAL_AUTOIMAGECAL_OFF | RF_IMAGECAL_TEMPTHRESHOLD_10 | RF_IMAGECAL_TEMPMONITOR_ON), \
		(REG_LOWBAT | RFM_WRITE),			(RF_LOWBAT_OFF | RF_LOWBAT_TRIM_1835), \
		(REG_DIOMAPPING1 | RFM_WRITE),		(RF_DIOMAPPING1_DIO0_00 | RF_DIOMAPPING1_DIO1_10 | RF_DIOMAPPING1_DIO2_10 | RF_DIOMAPPING1_DIO3_00), \
		(REG_DIOMAPPING2 | RFM_WRITE),		(RF_DIOMAPPING2_DIO4_00 | RF_DIOMAPPING2_DIO5_00 | RF_DIOMAPPING2_MAP_RSSI), \
		(REG_PADAC | RFM_WRITE),			(RF_PADAC_20DBM_OFF), \
		(REG_OPMODE | RFM_WRITE), 			(RF_OPMODE_LONGRANGEMODE_OFF | RF_OPMODE_MODULATIONTYPE_FSK | RF_OPMODE_SLEEP) \
		}
